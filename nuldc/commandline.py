...
model_option = typer.Option("works", "--model", help="Model (works, collections, filesets)")
...
def csv(
    ...
    handle_search(query, "works", "csv", fields, exclude_fields, all_records, outfile)
...
def xml(
    ...
    handle_search(query, "works", "xml", fields, exclude_fields, all_records, outfile)
